...
function M.create_pr_previewer()
  ...
  Job:new({
    ...
    on_exit = function(_, return_val)
      if return_val == 0 then
        ...
        vim.notify("Failed to switch to branch " .. selection.value.branch_ref, vim.log.levels.ERROR)
      end
    end,
  }):start()
end
